...
export abstract class AbstractName implements Name {
    ...
    constructor(delimiter: string = DEFAULT_DELIMITER) {
        ...
        // Verify object state after construction
    ...
    public isEqual(other: Object): boolean {
        // Precondition: check if other is null/undefined (fail gracefully or assert depending on strictness)
        // Here we follow standard equality pattern: null returns false
        if (other === null || other === undefined) {
            return false;
        }

        // Structural check
        // Cast to any to check for method existence, safe guard against incompatible types
     ...
     * Should be called after constructors and public mutators in subclasses if feasible.
     */
